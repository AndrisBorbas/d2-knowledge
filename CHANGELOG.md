...
- Per shot and sustained DPS rows print the conditions and loadout behind each number in full under the row, instead of truncating them into a column.
...
- Opening a shared link to an expanded weapon row loads its perk hover cards right away instead of only after the row is closed and opened again.

## [1.6.1] - 2026-09-10

### Fixed

- Artifact perks show the correct icon.
