...
import { DdcVariantProvider } from "@/components/tooltip/DdcVariantContext";
...
export function SubclassExplorer({
	...
	return (
		// The sheet names each element's tab after the element.
		<DdcVariantProvider value={selected.element}>
