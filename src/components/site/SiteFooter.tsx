...
export function SiteFooter({ generatedAt }: SiteFooterProps) {
	return (
		<footer className="p-4 backdrop-blur-md md:px-6 lg:px-8">
			<div className="mt-3 flex items-center gap-2">
				<Image
					...
					height={32}
				/>
				<span className="text-masterwork text-shadow-masterwork/60 text-4xl font-semibold text-shadow-[0px_0px_7px] md:text-4xl">
					Owl Sector
				</span>
			</div>

			<div className="borderHover mt-6 space-y-2 bg-white/6 p-4 text-sm text-white/60">
				<p>
